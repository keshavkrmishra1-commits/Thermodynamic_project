...
st.markdown("<h1 style='text-align: center; color: #2C3E50;'>Thermodynamic Property Database</h1>", unsafe_allow_html=True)
st.markdown("<p style='text-align: center; font-size: 1.1em; color: #7F8C8D;'>MCR-102 Project Submission • Department of Ceramic Engineering</p>", unsafe_allow_html=True)
st.divider()
